...
const JA_MESSAGES = {
  ...
  "notice.archived": "アーカイブしました",
  "notice.restored": "メイン一覧に戻しました",
  ...
  "action.archive": "アーカイブする",
  "action.restore": "メイン一覧に戻す",
  "action.delete": "削除",
  "action.actions": "操作",
...
const EN_MESSAGES: Record<TranslationKey, string> = {
  ...
  "notice.archived": "Entry archived.",
  "notice.restored": "Entry restored to the main list.",
  ...
  "action.restore": "Restore to main list",
